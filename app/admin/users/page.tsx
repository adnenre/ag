...
import { Search, ArrowUpDown, MoreHorizontal, Check, X, Shield, User, Users, Edit } from "lucide-react"
                    ...
                    <TableRow key={user.id}>
                      ...
                      <TableCell className="text-center">
                        <Switch
                          ...
                          onCheckedChange={(checked) => toggleUserStatus(user.id, checked ? "active" : "inactive")}
